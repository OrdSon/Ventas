...
public class PanelCompras extends javax.swing.JPanel {
    ...
    private void crearNuevaCompra(){
        FrameNuevaCompra nuevaCompra = new FrameNuevaCompra();
    ...
    private void initComponents() {
        ...
        txtBuscarCodigo.setText("COMPRA-000");
        ...
        lblBuscarNombre.setText("BUSCAR PROVEEDOR");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        txtBuscarNombre.setText("PROVEEDOR");
        ...
        lblBuscarPorTienda2.setText("NUEVA COMPRA");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        jButton2.setToolTipText("Ordenar por proveedor");
        ...
        jButton3.setToolTipText("Ordenar por total de compra");
